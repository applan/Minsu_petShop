...
<p class="user-modify">
   ...
   <div class="form-group text-center" style="padding-right:50px; padding-top: 5px;">      
      <input type="submit" class="btn btn-primary gradient" style="background-color: red; border-color:red;" value="수정">
       <button type="button" class="btn btn-primary gradient" style="background-color: red; border-color:red; color:white;" onclick='history.back()'>취소</button>      
